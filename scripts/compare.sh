...
$PHP_BIN src/bin/pdepend.php --jdepend-xml=/tmp/jdpb0.xml --summary-xml=/tmp/sumb0.xml $1
$PHP_BIN src/bin/pdepend.php --jdepend-xml=/tmp/jdpb1.xml --summary-xml=/tmp/sumb1.xml $1
